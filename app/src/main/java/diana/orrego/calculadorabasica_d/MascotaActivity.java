...
public class MascotaActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        try {
            ...
            Button btnGuardarRegistro = findViewById(R.id.btnGuardarMascota);
    ...
    private void guardarDatosFirebase(){
        try {
            TextView tempVal = findViewById(R.id.txtNombreMascota);
            ...
            TextView tempVal2 = findViewById(R.id.txtResponsable);
            String Responsable = tempVal2.getText().toString();

            TextView tempVal4 = findViewById(R.id.txtSexo);
            String Sexo= tempVal4.getText().toString(),

                    id = mDatabse.push().getKey();
            Mascotas user = new Mascotas(Nombre,correo, urlCompletaImg, urlCompletaImgFirestore, miToken ,edad ,telefono,Responsable,Sexo);
            if (id != null) {
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        try {
                            Uri photoURI = FileProvider.getUriForFile(MascotaActivity.this, "com.ugb.calculadora.fileprovider", photoFile);
