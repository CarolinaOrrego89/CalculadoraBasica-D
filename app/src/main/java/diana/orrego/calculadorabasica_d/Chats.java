...
public class Chats extends Activity {
    ...
    private class enviarDatos extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                urlConnection.setRequestProperty("Authorization", "key=AAAAEU_4KZU:APA91bEhLxJ5EmkFsKRKa-qkNJijo9oHl_WYDgl1KaeWUpjQmZak17A4EM1Orwa4RMNcNywH5nranfhZ9UW6Un5Tlr0aEWbSreUy8Bfyv6NVObxZTAHH8nqNHk3-R4LrUN1aW4OXKtfP");
    ...
    private final BroadcastReceiver notificacionPush = new BroadcastReceiver() {
        @Override
